            ...
            <div class="row margin-three">
                ...
                <?php if($enable_footer_logo == 1){ ?>
                    ...
                    <div class="footer-logo">
                        <a href="<?php echo home_url(); ?>"><img alt="<?php echo get_bloginfo('name') ?>" src="<?php echo $footer_logo['url'];?>" width="<?php echo $footer_logo['width'] ?>" height="<?php echo $footer_logo['height'] ?>"></a>
                    </div>
                    <!-- end logo -->
                <?php }?>
            </div>

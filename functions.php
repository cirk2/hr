...
function remove_hcode_modernizr() {
    wp_deregister_script('hcode-modernizr');
    wp_dequeue_script('hcode-modernizr');
}
add_action('wp_enqueue_scripts', 'remove_hcode_modernizr', 11);
...
add_action('wp_enqueue_scripts', 'custom_hamburger_js', 13);
...
add_action('wp_enqueue_scripts', 'custom_modal_js', 19);

function custom_waypoints() {
    wp_deregister_script('waypoints');
    wp_dequeue_script( 'waypoints');
    wp_register_script('reflect-waypoints', get_stylesheet_directory_uri().'/js/waypoints.min.js');
    wp_enqueue_script('reflect-waypoints');
}
add_action('wp_enqueue_scripts', 'custom_waypoints', 45);

                            ...
                            $output .= '<div class="slider-text-middle-main">';
                                $output .= '<div class="slider-text-bottom slider-text-middle5 text-left animated fadeInUp">';
                                    if( $background_slide_number == 'custom-number' && $background_slide_custom_number ) {
                                        $output .= '<span class="slider-number alt-font black-text border-color-black">'.$background_slide_custom_number.'</span>';
            ...
            case 'hcode-owl-slider22':
                ...
                $slider_config .= 'mouseDrag: false, ';
                    ...
                    $output .= '<div class="work-background-slider-text" '.$background_slide_bg_color.'>';
                        $output .= '<div class="slider-text-bottom slider-text-middle5 text-left no-padding">';
                            if( $background_slide_number == 'custom-number' && $background_slide_custom_number ) {
                                $output .= '<span class="parallax-number alt-font black-text no-margin-top">'.$background_slide_custom_number.'</span>';
                            } elseif( $background_slide_number != 'custom-number' ) {
                            ...
                            $output .= '<div class="slider-text-middle-main">';
                                $output .= '<div class="slider-text-middle">';
                                    ...
                                    if($first_button_config && $no_button){
                                        $output .= '<a class="btn-small-white btn btn-medium margin-four no-margin-bottom no-margin-right inner-link" href="'.$first_button_link.'" target="'.$first_button_target.'">'.$first_button_title.'</a>';
                                    }
                                $output .= '</div>';
                            $output .= '</div>';
                        $output .= '</div>';
                        ...
                        $output .= '<div class="slider-typography">';
                            $output .= '<div class="slider-text-middle-main">';
                                $output .= '<div class="slider-text-middle">';
                                    ...
                                    if($first_button_config && $no_button){
                                        $output .= '<a class="starting text-med text-uppercase font-weight-600 letter-spacing-2 black-text margin-two bg-golden-yellow display-inline-block inner-link" href="'.$first_button_link.'" target="'.$first_button_target.'">'.$first_button_title.'</a>';
                                    }
                                $output .= '</div>';
                            $output .= '</div>';
                        $output .= '</div>';
                        ...
                        $output .= '<div class="slider-typography slider-typography-shop text-left">';
                            $output .= '<div class="slider-text-middle-main">';
                                $output .= '<div class="slider-text-middle padding-left-right-px animated fadeInUp">';
                                    ...
                                    if($first_button_config && $no_button){
                                        $output .= '<a class="highlight-button-dark btn margin-four inner-link" href="'.$first_button_link.'" target="'.$first_button_target.'">'.$first_button_title.'</a>';
                                    }
                                $output .= '</div>';
                            $output .= '</div>';
                        $output .= '</div>';
                        ...
                        $output .= '<div class="slider-typography text-left">';
                            $output .= '<div class="slider-text-middle-main">';
                                $output .= '<div class="slider-text-middle padding-left-right-px animated fadeInUp">';
                                    ...
                                    if($first_button_config && $no_button){
                                        $output .= '<a class="highlight-button-black-border btn btn-small inner-link" href="'.$first_button_link.'" target="'.$first_button_target.'">'.$first_button_title.'</a>';
                                    }
                                $output .= '</div>';
                            $output .= '</div>';
                        $output .= '</div>';
                            ...
                            $output .= '<div class="slider-text-middle-main pull-left text-left">';
                                $output .= '<div class="slider-text-middle">';
                                    ...
                                    if($content != '' || ($first_button_config != '' || $no_button)){
                                        ...
                                        $output .= do_shortcode( $content );
                                        if( ($first_button_config != '' || $no_button) ) {
                                            $output .= ' <a class="black-text font-weight-600 bg-yellow inner-link" href="'.$first_button_link.'" target="'.$first_button_target.'"><span class="black-text font-weight-600">'.$first_button_title.'</span></a>';
                                        }
                                        $output .= '</span>';
                                    }
                                $output .= '</div>';
                        ...
                        $output .='<div class="slider-typography">';
                            $output .='<div class="slider-text-middle-main">';
                                $output .='<div class="slider-text-middle">';
                                    ...
                                    if($first_button_config && $no_button){
                                        $output .='<a class="btn-small-white-background btn btn-small no-margin inner-link" href="'.$first_button_link.'" target="'.$first_button_target.'">'.$first_button_title.'</a>';
                                    }
                                $output .='</div>';
                            $output .='</div>';
                        $output .='</div>';
                            ...
                            $output .= '<div class="slider-text-middle-main">';
                                $output .= '<div class="slider-text-middle slider-text-middle6 padding-left-right-px wow fadeInUp animated">';
                                    $output .= '<div class="col-md-12 text-left animated fadeInUp no-padding">';
                                        if($title){
                                            $output .= '<span class="slider-title-big6 sm-slider-title-big6 xs-width-100 xs-slider-title-big6 xs-text-center orange-light-text font-weight-700 text-decoration-underline display-inline-block margin-five no-margin-lr no-margin-top"'.$hcode_title_color.'>'.$title.'</span>';
                                        }
                                        if($content){
                                            $output .= do_shortcode( hcode_remove_wpautop( $content ) );
                                        }

...
(function($) {
    ...
    // TODO
    //
    // => get everything in window.load loaded after vc is loaded

    $(window).load(function() {

    function trimExcerpt() {
        var excLength = 50;
    ...
    function() {
        ...
        $(this).text(
            $(this).text().substring(0, excLength) + escapeHtml("&hellip;") );
        }
    }
        );
    }
    setTimeout(trimExcerpt, 2000);


    //
    // TODO
    //
    // => fix modernizr detection in js
    // if ( Modernizr.shapes )

    if (jQuery('html').hasClass('has_shapes')) {
        function addShapes() {
    jQuery('.custom-post-grid .vc_gitem-link p')
...
//  console.log(pathLengths);
  ...
  $(window).scroll(function(e) {
    if ($(window).scrollTop() === 0) {
      console.log('top');
      $('.section-logo.animated').removeClass('animated wpb_start_animation');
    }
  });
